...
analyze -format verilog {fir_16tap.v}
elaborate fir_16tap; # top module name

# store the unmapped results
write -hierarchy -format ddc -output results/fir_16tap.unmapped.ddc
...
source fir_16tap.constraints.tcl
...
check_design > reports/fir_16tap.check_design.rpt; # dump to the file
...
# Write out design
write -format verilog -hierarchy -output results/fir_16tap.mapped.v
write -format ddc -hierarchy -output results/fir_16tap.mapped.ddc
write_sdf results/fir_16tap.mapped.sdf
write_sdc -nosplit results/fir_16tap.mapped.sdc

# Generate reports
report_qor > reports/fir_16tap.mapped.qor.rpt
report_timing -transition_time -nets -attribute -nosplit \
  > reports/fir_16tap.mapped.timing.rpt
report_area -nosplit > reports/fir_16tap.mapped.area.rpt
report_power -nosplit > reports/fir_16tap.mapped.power.rpt
