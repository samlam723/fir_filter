...
# fir_16tap. The P&R flow is based on the EDI 13.1 official workshop and use the
...
set init_verilog "designs/fir_16tap.mapped.v"
...
# starting from the left offset 20.0 (roughly middle of the fir_16tap module)
...
saveDesign db/fir_16tap_powerplan.enc
...
saveDesign db/fir_16tap_place.enc
...
saveDesign db/fir_16tap_cts.enc
...
saveDesign db/fir_16tap_postroute.enc
...
verifyGeometry -report reports/fir_16tap.geometry.rpt
verifyConnectivity -type all -report reports/fir_16tap.connectivity.rpt
...
report_area -out_file reports/fir_16tap.routed.area.rpt

# Power report
report_power -outfile reports/fir_16tap.routed.power.rpt

# ------------------------------------------------------------------------------
# Step 7b. Exports the design
# ------------------------------------------------------------------------------
# SPEF file: parastic data of wires
rcOut -spef results/fir_16tap.spef -rc_corner rc_worst

# SDF file: delay files for gates and wires
write_sdf results/fir_16tap.sdf

# *.v: verilog netlist file
saveNetlist results/fir_16tap.routed.v

# *.gds: GDS file
streamOut results/fir_16tap.gds -mapFile streamOut.map \
